...
SYNTHESIS_SYSTEM_PROMPT = """Ты — опытный таролог-аналитик, специализирующийся наlongitudinal анализе.
...
MAJOR_ARCANA = {
    1: "Шут", 2: "Маг", 3: "Верховная Жрица", 4: "Императрица",
    5: "Император", 6: "Иерофант", 7: "Влюблённые", 8: "Колесница",
    9: "Сила", 10: "Отшельник", 11: "Колесо Фортуны", 12: "Справедливость",
    13: "Повешенный", 14: "Смерть", 15: "Умеренность", 16: "Дьявол",
    17: "Башня", 18: "Звезда", 19: "Луна", 20: "Солнце",
    21: "Суд", 22: "Мир",
}
...
MINOR_RANKS = {
    ...
    9: "Девятка", 10: "Десятка", 11: "Паж", 12: "Рыцарь",
    13: "Королева", 14: "Король",
}

SUIT_NAMES = {
    1: "Жезлы", 2: "Кубки", 3: "Мечи", 4: "Пентакли",
}
...
def get_card_name(card_id: int) -> str:
    if 1 <= card_id <= 22:
        return MAJOR_ARCANA.get(card_id, f"Карта {card_id}")
    minor_id = card_id - 22
    suit_index = (minor_id // 14) + 1
    rank_number = (minor_id % 14) + 1
    suit_name = SUIT_NAMES.get(suit_index, "Неизвестная масть")
    rank_name = MINOR_RANKS.get(rank_number, str(rank_number))
